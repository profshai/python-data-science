...
Core numerical computing concepts using NumPy:
...
Working with time series and date data:
...
Fundamentals of visualization using Matplotlib:
...
### `01_basic_simulated.ipynb`

Simulation based statistical concepts:
